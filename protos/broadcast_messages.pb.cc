...
static ::_pb::Metadata file_level_metadata_broadcast_5fmessages_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_broadcast_5fmessages_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_broadcast_5fmessages_2eproto = nullptr;

const uint32_t TableStruct_broadcast_5fmessages_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_broadcast_5fmessages_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\030broadcast_messages.proto\022\004chat\"=\n\021Broa"
  "dcastDelivery\022\017\n\007message\030\001 \001(\t\022\027\n\017userna"
  "me_origin\030\002 \001(\tb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_broadcast_5fmessages_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_broadcast_5fmessages_2eproto = {
    false, false, 103, descriptor_table_protodef_broadcast_5fmessages_2eproto,
    "broadcast_messages.proto",
    &descriptor_table_broadcast_5fmessages_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_broadcast_5fmessages_2eproto::offsets,
    file_level_metadata_broadcast_5fmessages_2eproto, file_level_enum_descriptors_broadcast_5fmessages_2eproto,
    file_level_service_descriptors_broadcast_5fmessages_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_broadcast_5fmessages_2eproto_getter() {
  return &descriptor_table_broadcast_5fmessages_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_broadcast_5fmessages_2eproto(&descriptor_table_broadcast_5fmessages_2eproto);
namespace chat {
...
::PROTOBUF_NAMESPACE_ID::Metadata BroadcastDelivery::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_broadcast_5fmessages_2eproto_getter, &descriptor_table_broadcast_5fmessages_2eproto_once,
      file_level_metadata_broadcast_5fmessages_2eproto[0]);
}
