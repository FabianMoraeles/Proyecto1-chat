...
static ::_pb::Metadata file_level_metadata_get_5fuser_5finfo_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_get_5fuser_5finfo_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_get_5fuser_5finfo_2eproto = nullptr;

const uint32_t TableStruct_get_5fuser_5finfo_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_get_5fuser_5finfo_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static ::_pbi::once_flag descriptor_table_get_5fuser_5finfo_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_get_5fuser_5finfo_2eproto = {
    false, false, 102, descriptor_table_protodef_get_5fuser_5finfo_2eproto,
    "get_user_info.proto",
    &descriptor_table_get_5fuser_5finfo_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_get_5fuser_5finfo_2eproto::offsets,
    file_level_metadata_get_5fuser_5finfo_2eproto, file_level_enum_descriptors_get_5fuser_5finfo_2eproto,
    file_level_service_descriptors_get_5fuser_5finfo_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_get_5fuser_5finfo_2eproto_getter() {
  return &descriptor_table_get_5fuser_5finfo_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_get_5fuser_5finfo_2eproto(&descriptor_table_get_5fuser_5finfo_2eproto);
namespace chat {
...
::PROTOBUF_NAMESPACE_ID::Metadata GetUserInfo::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_get_5fuser_5finfo_2eproto_getter, &descriptor_table_get_5fuser_5finfo_2eproto_once,
      file_level_metadata_get_5fuser_5finfo_2eproto[0]);
}
